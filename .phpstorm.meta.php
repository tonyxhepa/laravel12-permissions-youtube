...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/tony/code/laravel-permission/public/storage' => 'string',
...
'filesystems.links./Users/tony/code/laravel-permission/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'appearance.edit','two-factor.show','users.index','users.create','users.edit',
'posts.index','posts.create','posts.edit','roles.index','roles.create',
'roles.edit','permissions.index','permissions.create','permissions.edit','storage.local',);
...
'livewire.auth.reset-password','livewire.auth.two-factor-challenge','livewire.auth.verify-email','livewire.permissions.permission-create','livewire.permissions.permission-edit',
'livewire.permissions.permission-index','livewire.posts.post-create','livewire.posts.post-edit','livewire.posts.post-index','livewire.roles.role-create',
'livewire.roles.role-edit','livewire.roles.role-index','livewire.settings.appearance','livewire.settings.delete-user-form','livewire.settings.password',
'livewire.settings.profile','livewire.settings.two-factor','livewire.settings.two-factor.recovery-codes','livewire.users.user-create','livewire.users.user-edit',
'livewire.users.user-index','partials.head','partials.settings-heading','welcome','e60dd9d2c3a62d619c9acb38f20d5aa5::accent',
