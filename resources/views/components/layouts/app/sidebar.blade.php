        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                ...
                @canany(['view_posts', 'view_any_posts'])
                    <flux:navlist.item icon="document" :href="route('posts.index')"
                        :current="request()->routeIs('posts.index')" wire:navigate>Posts</flux:navlist.item>
                @endcanany
                @canany(['view_roles', 'view_any_roles'])
                    <flux:navlist.item icon="lock-closed" :href="route('roles.index')"
                        :current="request()->routeIs('roles.index')" wire:navigate>Roles</flux:navlist.item>
                @endcanany
                @canany(['view_permissions', 'view_any_permissions'])
                    <flux:navlist.item icon="key" :href="route('permissions.index')"
                        :current="request()->routeIs('permissions.index')" wire:navigate>Permissions</flux:navlist.item>
                @endcanany
            </flux:navlist.group>
        </flux:navlist>
